...
set output "bg0x01_A000_xfer_model_P3_PhlF.eps"
...
set format x ""    
set xlabel '00000001'
set arrow from 0.0775630453125443,0.001 to 0.0775630453125443,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
set arrow from 2.431755081814977,0.001 to 2.431755081814977,1000.0 nohead lw 10 lt 2 lc rgb '#000000'
ymin = 0.02
ymax = 6.8
n = 4.2
K = 0.23
