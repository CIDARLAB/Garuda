...
public class Guy_Parser {
    ...
    //@Setter
    //@Getter
    //private static List<Feature> partsID;
    
    //@Setter
    //@Getter
    //private static List<Feature> constructsID;
    
    //@Setter
    //@Getter
    //private static List<BioDesign> genDataID;
        ...
        try
        {
            ...
            for (int i=0; i<workbook.getNumberOfSheets(); i++) {
                ...
                switch (sheetName) {
                    ...
                    case "Parts":
                    case "parts":
                        parts = populateParts (sheet, outputUrl, username);
                        break;
                    case "Constructs":
                    case "constructs":
    ...
    public static Map<String, String> populateParts (XSSFSheet sheet, String outputFileUrl, String username) {
